...
:::note[ASI Properties]
The example and the other code may use semicolons, but the compiler has Automatic Semicolon Insertion (ASI) properties and only really required when doing single-line code.
:::